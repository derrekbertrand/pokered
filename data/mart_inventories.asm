...
LavenderMartText1:: ; 246a (0:246a)
	db $FE,8,GREAT_BALL,SUPER_POTION,ESCAPE_ROPE,SUPER_REPEL
	db ANTIDOTE,BURN_HEAL,ICE_HEAL,PARLYZ_HEAL,$FF

; Celadon Dept. Store 2F (1)
CeladonMart2Text1:: ; 2476 (0:2476)
	db $FE,8,GREAT_BALL,SUPER_POTION,SUPER_REPEL,ANTIDOTE
...
FuchsiaMartText1:: ; 24a8 (0:24a8)
	db $FE,6,ULTRA_BALL,GREAT_BALL,SUPER_POTION,ANTIDOTE,FULL_HEAL
	db SUPER_REPEL,$FF

; unused? 24b1
	db $FE,4,GREAT_BALL,HYPER_POTION,SUPER_POTION,FULL_HEAL,$FF

; Cinnabar
CinnabarMartText1:: ; 24b9 (0:24b9)
	db $FE,7,ULTRA_BALL,GREAT_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE
	db BURN_HEAL,FULL_HEAL,$FF
